...
__version__ = "1.0"
__author__  = "Andrew Cooper <andrew.cooper3@citrix.com>"
...
class MAC(object):
    ...
    def is_valid(cls, addr):
        """ Static method to assertain whether addr is a recognised MAC address
        or not"""
        try:
            MAC(addr)
        except Exception:
    ...
    def __hash__(self):
        return int(self.integer ^ (self.integer >> 24))
